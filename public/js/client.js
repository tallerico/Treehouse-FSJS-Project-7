...
const tweetBox = document.querySelector('.app--tweet--list');
const tweetList = tweetBox.querySelectorAll('li');
...
submitButton.addEventListener("click", (e) => {
  ...
  socket.on('update_tweets', (data) => {
    var tweet = document.createElement('li');
    tweetBox.insertBefore(tweet, tweetBox.childNodes[0]);
    tweetBox.childNodes[0].innerHTML = `
    ...
    `;
    tweetBox.removeChild(tweetBox.lastChild);
  })
});
